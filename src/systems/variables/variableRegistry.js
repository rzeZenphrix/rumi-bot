...
function staticMap(context = {}) {
  ...
  return {
    ...
    'giveaway.id': giveaway.guild_number ? `#${giveaway.guild_number}` : (giveaway.message_id || giveaway.public_id),
    'giveaway.number': giveaway.guild_number ? `#${giveaway.guild_number}` : null,
