...
module.exports = {
  ...
  async execute({ message, args }) {
    ...
    return respond.reply(message, '', '-# Use\n```nsfw status or nsfw toggle <on|off>```');
  }
};
